...
unsigned int nModifierInterval = 10 * 60; // CompCoin - time to elapse before new modifier is computed
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    {
        nSubsidy = 6400000 * COIN;
    }
	    else if(pindexBest->nHeight+1 >= 2 && pindexBest->nHeight+1 <= 6000)
    {
        nSubsidy = 0 * COIN;
}
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (IsProofOfStake())
    {
        ...
        // CompCoin: check proof-of-stake block signature
...
// CompCoin: attempt to generate suitable proof-of-stake
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "CompCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    {
        bnTrustedModulus.SetHex("");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "CompCoin Nov.18.2017";
        CTransaction txNew;
        txNew.nTime = 1510967780;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1510967780;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 11567192;
		if(fTestNet)
        {
            block.nNonce   = 67;
        }
       ...
       if (true && (block.GetHash() != hashGenesisBlock)) {
        ...
        assert(block.hashMerkleRoot == uint256("0x39f0002ab9457350b9f8ac680dfcdb9833ee792cf088e832bf52209640535268"));
...
unsigned char pchMessageStart[4] = { 0xb1, 0xb6, 0xf8, 0xa6 };
